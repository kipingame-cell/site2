...
export function renderOctagram(svg, m, { onPointClick } = {}) {
  ...
  mid(at('top', 0.42).x - 32, at('top', 0.42).y, 'линия Неба', -90);       // слева, вдоль луча
  mid(at('left', 0.43).x, CY + 26, 'линия Земли');                      // под левым лучом
  mid(at('bottom', 0.57).x + 32, at('bottom', 0.57).y, 'кармический хвост', -90); // справа от нижнего луча
  mid(at('leftTop', 0.62).x + 22, at('leftTop', 0.62).y - 22, 'линия мужского рода', 45);  // вдоль диагонали, ближе к углу
