...
export function renderOctagram(svg, m, { onPointClick } = {}) {
  ...
  mid(at('leftTop', 0.58).x + 20, at('leftTop', 0.58).y - 20, 'линия мужского рода', 45);  // вдоль диагонали, ближе к углу
  mid(at('rightTop', 0.58).x + 20, at('rightTop', 0.58).y + 20, 'линия женского рода', -45);
